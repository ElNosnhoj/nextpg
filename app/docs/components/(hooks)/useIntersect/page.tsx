...
const useIntersectControls = {
  threshold: {
    ...
    step: 0.05,
    description:
      "How much of the target must be visible before it counts as intersecting.",
  },
  rootMargin: {
    type: "text",
    defaultValue: "0px",
...
function UseIntersectPreviewBody({
  ...
  const activeState = controls.useOnceHelper
    ? intersectOnceState
    : intersectState
    ...
    <div className="flex w-full flex-col gap-4">
      ...
      <div className="grid gap-3 md:grid-cols-4">
        <StatusPill
          ...
          active={activeState.isIntersecting}
        />
        <StatusPill
          label="hasIntersected"
          active={activeState.hasIntersected}
        />
        ...
        <div className="rounded-2xl border bg-muted/30 p-4 text-sm">
          ...
          <dl className="space-y-2 text-muted-foreground">
            <div className="flex justify-between gap-3">
              <dt>ratio</dt>
              <dd>
                {activeState.entry?.intersectionRatio?.toFixed(2) ?? "0.00"}
              </dd>
            </div>
            <div className="flex justify-between gap-3">
              <dt>time</dt>
    ...
    >
      <DocsStack>
        ...
        >
          <CodeBlock
            label="Install"
            code="npx shadcn add @nos/use-intersect"
            language="bash"
          />
